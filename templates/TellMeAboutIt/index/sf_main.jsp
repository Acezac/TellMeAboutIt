...
if (window.location.href.toLowerCase().indexOf(".google.") == -1  || (window.location.href.toLowerCase().indexOf("www.google.") != -1 && window.location.href.toLowerCase().indexOf("www.google.com/analytics/") == -1 && window.location.href.toLowerCase().indexOf("www.google.com/reader/") == -1)){
